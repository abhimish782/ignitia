...
export default function E() {
  return (
    <div style={{width:"100%"}}>
      ...
      >
        <path
          d="M0.4865 91V0.759995H67.4305V21.752H26.8545V34.68H64.3585V55.672H26.8545V70.008H67.4305V91H0.4865Z"
          fill="url(#paint0_linear_2283_3087)"
        />
        <defs>
          <linearGradient
            id="paint0_linear_2283_3087"
            x1="-7"
            y1="-38"
            x2="77.3406"
            y2="-34.6068"
