import devStyles from "@/styles/Devs.module.css";
import developersStyles from "@/styles/Developers.module.css";
...
export default function DevelopersModel(props) {
    ...
    return (
        <div className={devStyles.devModelBody} ref={ref}  style={{backgroundImage:"url("+ props.background +")"}}>
            <div className={devStyles.devModelCont}>
                <h2 className={`${devStyles.modelHead} secHead`}>{props.team}</h2>
                <svg
                    className={`${developersStyles.close} ${devStyles.close}`}
                ...
                <div className={devStyles.modelContainer}>
                    {props.devs.map((dev) => {
                        return <DeveloperCard dev={dev} />
                    })}
                </div>
            </div>
        </div >
